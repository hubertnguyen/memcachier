<?php
// !!!!!!!! Version Modified to work with Memcachier, without ALSL AUTH, by Hubert Nguyen h@ubergizmo.com
/*
	...
	function WP_Object_Cache() {
		...
		foreach ( $buckets as $bucket => $servers) {
			...
			foreach ( $servers as $server  ) {
				...
				$this->mc[$bucket]->set(MEMCACHIER_USER, MEMCACHIER_PASSWORD); // !!! MEMACHIER AUTH for non-SASL clients. Nice trick!
			}
		}
